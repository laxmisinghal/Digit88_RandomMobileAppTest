...
import com.random.utilities.GetScreenShot;
...
public class CustomListeners extends TestBase implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		 ...
		 * try { test.log(LogStatus.PASS, test.addScreenCapture(
		 * GetScreenShot.capture(driver, Integer.toString(new
		 * Random().nextInt(1000000000))))); } catch (IOException e) {
		 * e.printStackTrace(); } reports.endTest(test); reports.flush();
		 */
		try {
		...
		Reporter.log("<br>");
		Reporter.log("<a target=\"_blank\" href=" + GetScreenShot.screenShotName + "><img src="
				+ GetScreenShot.screenShotName + " height=200 width=200> </img></a>");

		// Reporter.log("<a target=\"_blank\"
		// href="+GetScreenShot.captureScreeshot()+"><img
		// src="+GetScreenShot.captureScreeshot()+" height=200 width=200>
		// </img></a>");
	...
	public void onTestFailure(ITestResult result) {
		 ...
		 * " Failed with exception" + result.getThrowable()); try {
