...
public class GetScreenShot extends Base {
	public GetScreenShot(AppiumDriver driver) {
		super(driver);
	}
	...
	public static String captureScreeshot() throws IOException {
		 ...
		 * String dest = "screenshots/" + screenShotName + ".png"; File
		...
		// File(System.getProperty("user.dir")+"\\target\\surefire-reports\\html\\"+screenShotName+".png");
